        ...
        return(
            <div>
                ...
                <div className="row align-items-center">
                    <img className="wbdv-course-widget-image img-fluid img-thumbnail"
                ...
                <div className="border m-3 p-2 rounded">
                    ...
                    <h3>Preview</h3>
                    {this.state.widget.src !== "" && <img className="wbdv-course-widget-image-preview img-fluid"
                                                          src={this.state.widget.src}
                                                          alt="Invalid URL"/>}
                    {this.state.widget.src === "" && <p>Please Enter a Valid URL!</p>}
